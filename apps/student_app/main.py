...
class StudentWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        act_link = QAction(std_icon(QStyle.SP_DirLinkIcon), "Link root…", self)
        ...
        act_link.setShortcut(QKeySequence("Ctrl+L"))
        ...
        act_link.triggered.connect(self.link_remote_for_current)
        ...
        for a in (act_new, act_open, act_commit, act_submit, act_link, act_hist, act_inbox, act_restore):
            tb.addAction(a)
    ...
    def link_remote_for_current(self) -> None:
        ...
        if mapping:
            self.btn_refresh_inbox.setEnabled(True)
            QMessageBox.information(self, "Linked", "Students’ Root mapping saved for this manuscript.")
            self.refresh_inbox()
